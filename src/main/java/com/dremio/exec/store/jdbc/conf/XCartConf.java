...
@SourceType(value = "XCartARP", label = "XCart",uiConfig = "xcart-layout.json")
public class XCartConf extends AbstractArpConf<XCartConf> {
  private static final String ARP_FILENAME = "arp/implementation/xcart-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.xcart.XCartDriver";
